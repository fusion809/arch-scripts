...
export PATH=$HOME/perl5/bin:$HOME/bin:/usr/local/bin:/usr/lib/hardening-wrapper/bin:/usr/local/sbin:/usr/local/bin:/usr/bin:$GOROOT/bin:$GEMPATH:$PERL_PATH:$JAVA_HOME
