...
export PATH=$HOME/perl5/bin:/usr/local/bin:/usr/lib/hardening-wrapper/bin:/usr/local/sbin:/usr/local/bin:/usr/bin:$GOROOT/bin:$GEMPATH:$PERL_PATH:$JAVA_HOME:$HOME/.cargo/bin/
#:$HOME/bin
