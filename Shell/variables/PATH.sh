...
export PATH=/usr/local/bin:/usr/lib/hardening-wrapper/bin:/usr/local/sbin:/usr/bin:$GOPATH/bin:$GOROOT/bin:$GEMPATH:$PERL_PATH:$JAVA_HOME/bin:$HOME/.gem/ruby/2.4.0/bin:$HOME/.nix-profile/bin
